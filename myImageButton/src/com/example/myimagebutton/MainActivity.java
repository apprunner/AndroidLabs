...
import com.example.myimagebutton.R.id;
...
public class MainActivity extends ActionBarActivity {
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            //設OnClickListener事件，計算結果值
            
            //1.抓取ImageButton
            ImageButton ibtnSubmit = (ImageButton)rootView.findViewById(id.ibtnSubmit);
            ibtnSubmit.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View v) {
            	    ...
            	    tvResult.setText("結果值是：" + String.valueOf(arg1 * arg2));
				}
			});
